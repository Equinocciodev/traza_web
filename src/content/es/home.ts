...
export const home: HomeContent = {
  ...
  hero: {
    ...
    unitPreview: {
      ...
      fields: [
        ...
        { label: 'Producto / presentación', value: 'Solución oral Traza · frasco 120 ml' },
  ...
  chain: {
    eyebrow: 'El ciclo de vida',
    title: 'De la emisión a la consulta, cada paso deja un registro',
    intro:
      'La identidad de una unidad no se crea y se olvida: se emite, se activa cuando el lote cierra y desde entonces cada consulta deja rastro. Lo que el registro guarda son esos momentos, no el transporte.',
    nodes: [
      {
        id: 'issuance',
        label: 'Emisión',
    ...
    cta: { label: 'Ver el ciclo de vida completo', key: 'journey', variant: 'link' },
  },
  ...
  story: {
    ...
    fields: [
      ...
      },
      {
        ...
        description: 'De qué lote viene y cuándo vence, para compararlo con lo impreso en el envase.',
        icon: 'label',
      },
    ],
  },
  ...
  perspectives: {
    ...
    items: [
      ...
      },
      {
        ...
        body: 'Siga una unidad desde su emisión hasta las consultas que acumula, evento por evento, y vea cómo se construye su historia.',
