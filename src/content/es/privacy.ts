  ...
  sections: [
    {
      ...
      paragraphs: [
        'Este aviso se aplica a este sitio y a las páginas y herramientas interactivas que contiene. No describe las prácticas de un despliegue gobernado por una institución o una empresa, que cuenta con su propio aviso.',
        'El responsable del tratamiento es Traza Technology, C.A. Puede dirigirle cualquier consulta sobre privacidad por el canal indicado más abajo.',
      ],
    },
    {
    ...
    },
    {
      title: 'Formularios',
      paragraphs: [
        'El formulario de contacto compone un mensaje con los datos que escriba y lo abre en su propio cliente de correo: el envío lo realiza usted desde su cuenta. Este sitio no transmite esos datos por su cuenta ni los almacena.',
        'Los datos que nos escriba se usan únicamente para responderle. No los cedemos a terceros ni los empleamos para ninguna otra finalidad.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'La verificación de un producto no requiere identificarse, crear una cuenta ni facilitar datos personales. En este sitio, la consulta se resuelve en su navegador.',
        'Cuando la verificación se sirve desde el registro de un despliegue, el servicio necesita recibir el código consultado para responder; el aviso de ese despliegue explica qué se conserva, durante cuánto tiempo y con qué fin.',
      ],
    },
    {
    ...
    },
    {
      title: 'Contacto',
      paragraphs: [
        'Para cualquier asunto de privacidad puede escribir a Traza Technology, C.A. desde el formulario de la página de empresa, o al correo de contacto que figura en ella.',
      ],
    },
    {
      title: 'Cambios a este aviso',
      paragraphs: [
        'Este aviso puede actualizarse a medida que el sitio y la plataforma evolucionen. La fecha de la última actualización figura al inicio de la página.',
      ],
    },
  ],
};
