...
export const journey: JourneyContent = {
  meta: {
    title: 'Product journey and its recorded lifecycle events',
    description:
  ...
  hero: {
    ...
    subtitle:
      'Each unit brings together issuance, labeling, activation and lookup events. This page plays back what its record contains, with the responsible party, place and date.',
  },
  ...
  unitSelector: {
    ...
    options: [
      { code: 'TRZ-7F2K-4K7Q-92FA', label: 'Domestic oral solution · in progress with a recorded public lookup' },
      { code: 'TRZ-7F2K-3N6D-09ZB', label: 'Imported oral solution · with discrepancy report and inspection' },
      { code: 'TRZ-7F2K-8L1F-63HW', label: 'Imported oral solution · labelled but not activated (under review)' },
      { code: 'TRZ-7F2K-5R9C-77MQ', label: 'Domestic oral solution · lot revoked by the issuer' },
      { code: 'TRZ-7F2K-6C2A-84MZ', label: 'Oral solution · Traza master registry' },
  ...
  explain: {
    ...
    intro:
      'A journey brings together events supplied by the issuer and those generated by lookups on the platform. Each event states who records it, where, when and under which document reference; together they let anyone compare what the label says with what the registry holds.',
